...
echo "Update RandN_VPN-main files:"

export LC_ALL=C

rm -f /opt/randn_vpn-main/download/*

UPDATE_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/update.sh"
UPDATE_PATH="update.sh"

PARSE_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/parse.sh"
PARSE_PATH="parse.sh"

DOALL_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/doall.sh"
DOALL_PATH="doall.sh"
...
RPZ_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/rpz.txt"
RPZ_PATH="download/rpz.txt"

INCLUDE_HOSTS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/include-hosts.txt"
INCLUDE_HOSTS_PATH="download/include-hosts.txt"

EXCLUDE_HOSTS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/exclude-hosts.txt"
EXCLUDE_HOSTS_PATH="download/exclude-hosts.txt"

INCLUDE_ADBLOCK_HOSTS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/include-adblock-hosts.txt"
INCLUDE_ADBLOCK_HOSTS_PATH="download/include-adblock-hosts.txt"

EXCLUDE_ADBLOCK_HOSTS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/exclude-adblock-hosts.txt"
...
DISCORD_IPS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/discord-ips.txt"
DISCORD_IPS_PATH="download/discord-ips.txt"

CLOUDFLARE_IPS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/cloudflare-ips.txt"
CLOUDFLARE_IPS_PATH="download/cloudflare-ips.txt"

AMAZON_IPS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/amazon-ips.txt"
AMAZON_IPS_PATH="download/amazon-ips.txt"

HETZNER_IPS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/hetzner-ips.txt"
HETZNER_IPS_PATH="download/hetzner-ips.txt"

DIGITALOCEAN_IPS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/digitalocean-ips.txt"
DIGITALOCEAN_IPS_PATH="download/digitalocean-ips.txt"

OVH_IPS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/ovh-ips.txt"
OVH_IPS_PATH="download/ovh-ips.txt"

TELEGRAM_IPS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/telegram-ips.txt"
TELEGRAM_IPS_PATH="download/telegram-ips.txt"

GOOGLE_IPS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/google-ips.txt"
GOOGLE_IPS_PATH="download/google-ips.txt"

AKAMAI_IPS_LINK="https://raw.githubusercontent.com/RazisID12/RandN_VPN-main/main/setup/opt/randn_vpn-main/download/akamai-ips.txt"
AKAMAI_IPS_PATH="download/akamai-ips.txt"

function download {
	local path="/opt/randn_vpn-main/${1}"
...
if [[ -z "$1" || "$1" == "host" || "$1" == "hosts" ]]; then
	...
	if [[ "$ROUTE_ALL" = "y" ]]; then
		...
		printf '# НЕ РЕДАКТИРУЙТЕ ЭТОТ ФАЙЛ!' > /opt/randn_vpn-main/$EXCLUDE_HOSTS_PATH
	fi
	...
	if [[ "$BLOCK_ADS" = "y" ]]; then
		...
		> /opt/randn_vpn-main/$INCLUDE_ADBLOCK_HOSTS_PATH
		> /opt/randn_vpn-main/$EXCLUDE_ADBLOCK_HOSTS_PATH
		> /opt/randn_vpn-main/$ADGUARD_PATH
		> /opt/randn_vpn-main/$OISD_PATH
	fi
fi
...
###
FILE="/opt/randn_vpn-main/setup"

required_vars=(
"BLOCK_ADS="
"ALTERNATIVE_IP="
"OPENVPN_5080_5443_TCP="
"OPENVPN_5080_5443_UDP="
"SSH_PROTECTION="
"ATTACK_PROTECTION="
"ROUTE_ALL="
"DISCORD_INCLUDE="
